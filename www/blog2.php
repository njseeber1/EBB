  ...
  <div class="container">
      <div class="main">
          ...
          <div class="nav">
            ...
            <div class="innerhead">Eagle's Corner</div>
            <div class="bodytxt">
              <div class="bodyblog">
                        <h1>Our Blog</h1>
                    <p>A blog providing news and information about business oppurtunities, real estate, finance, insurance, laws etc.  and covers all the latest developments in the area of real estate - business oppurtunities in Colarado.</p>
              </div>
        <?php
        for($cnt = 0; $cnt < count($dtBlogs); $cnt++){
          echo '
          <div class="bodyblog">
            <h6>'.$dtBlogs[$cnt]->blogDate.'</h6>
            <h2>'.$dtBlogs[$cnt]->heading.'</h2>
            <img src="uploads/blogs/blog_'.$dtBlogs[$cnt]->blogId.'.jpg" />
