...
echo "\twindow.open('" . SM_PATH . "plugins/gpg/gpg_pop_init.php?MOD=passpop&psaction=decrypt','Decrypt_Now','status=yes,width=300,height=200,resizable=yes,scrollbars=yes');\n}\n}";
        echo 'document.write("<input type=\'button\' class=\'decrypt_button\' value=\'' . _("   Decrypt Message Now") . '\' onclick=\'gpg_decrypt_check(this)\'>");';
echo <<<TILLEND
        //-->
        </script>
        </p>
...
TILLEND;
echo 'document.write("<br><input type=\'submit\' name=\'encrypt\' class=\'encrypt_button\' value=\'' . _("    Encrypt Now") . '\' onclick=\"this.form.action=\'' . $addbasepath . '../plugins/gpg/gpg_encrypt.php\'\"> ");';
echo <<<TILLEND
//-->
</script>
TILLEND;
...
document.write("<input type='button' class='encrypt_button' name='gpgs' value='
TILLEND;
