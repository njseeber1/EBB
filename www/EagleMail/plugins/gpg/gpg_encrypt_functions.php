...
function gpg_decrypt($debug, $body, $passphrase, $filename='', $outfile=''){
    ...
    $body = escapeshellarg($body);
    /**
     *  patch submitted by Magyar DÈnes breaks decrypt from encrypt on send
 ...
 * re-integrated  patch provided by Magyar DÈnes to
 ...
 * added patch submitted by Magyar DÈnes to work around:
