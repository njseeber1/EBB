...
function showInputForm ($session, $values=false) {
    ...
    do_hook('compose_button_row'); // Encryption, spell checker buttons
...
function showComposeButtonRow() {
    ...
    echo '      <br> <INPUT TYPE=SUBMIT class="signature_button" NAME="sigappend" VALUE="   ' . _("Signature") . '">' . "\n";
    if ($use_javascript_addr_book) {
        ...
        echo '         <input type=submit class="address_button" name="html_addr_search" value="   '.
                                 _("Addresses").'">' . "\n";
    }

    if ($save_as_draft) {
        echo '         <input type="submit" class="savedraft_button" name ="draft" value="   ' . _("Save Draft") . "\">\n";
    }

    echo '         <INPUT type="submit" class="send_button" NAME="send" VALUE="     '. _("Send") . '">' . "\n";
