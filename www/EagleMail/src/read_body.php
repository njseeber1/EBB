 ...
 *
 * $Id: read_body.php,v 1.283.2.15 2004/04/26 23:48:38 jangliss Exp $
 */
...
function printer_friendly_link($mailbox, $passed_id, $passed_ent_id, $color) {
    ...
    $print_text = _("<img src=\"../images/fileprint.png\" border=\"0\" align=\"absmiddle\" alt=\"View Printable Version\">");
...
function formatEnvheader($mailbox, $passed_id, $passed_ent_id, $message, 
    ...
    $s .= ' ALIGN="center" class="message_header">';
    ...
    echo '<TR><TD HEIGHT="5" COLSPAN="2" BGCOLOR="white"></TD></TR><TR><TD align=center>'."\n";
    echo $s;
    do_hook('read_body_header');
    formatToolbar($mailbox, $passed_id, $passed_ent_id, $message, $color);
    echo '</TABLE>';
    echo '</TD></TR><TR><TD HEIGHT="5" COLSPAN="2" BGCOLOR="white"></TD></TR>'."\n";
    echo '</TABLE>';
}
...
function formatMenubar($mailbox, $passed_id, $passed_ent_id, $message, $mbx_response) {
    ...
    $topbar_delimiter = '&nbsp;<img src="../images/topbar_delimiter.png" align="absmiddle" border="0">&nbsp;';
    $urlMailbox = urlencode($mailbox);
    $s = '<table width="100%" cellpadding="3" cellspacing="0" align="center"'.
         ' border="0" class="read_icon_bar  BGCOLOR="'.$color[4].'"><tr>' .
    ...
    if (isset($where) && isset($what)) {
        ...
        $msgs_str  = _("<img src=\"../images/inbox_small.png\" border=\"0\" align=\"absmiddle\" alt=\"Message List\">");
    }
    ...
    if (!(isset($passed_ent_id) && $passed_ent_id)) {
        ...
        $s .= $topbar_delimiter;
        $s .= '<a href="' . $delete_url . '">' . _("<img src=\"../images/delete.png\" border=\"0\" align=\"absmiddle\" alt=\"Delete\">") . '</a>';
    }
    ...
    if (!(isset($where) && isset($what)) && !$passed_ent_id) {
        ...
        if ($prev != -1) {
            ...
            $s .= '<a href="'.$uri.'">'._("<img src=\"../images/back.png\" border=\"0\" align=\"absmiddle\" alt=\"Previous\">").'</a>';       
        } else {
            $s .= _("<img src=\"../images/back.png\" border=\"0\" align=\"absmiddle\" alt=\"Previous\">");
        }
        $s .= $topbar_delimiter;
        if ($next != -1) {
            $uri = $base_uri . 'src/read_body.php?passed_id='.$next.
                   '&amp;mailbox='.$urlMailbox.'&amp;sort='.$sort.
                   '&amp;startMessage='.$startMessage.'&amp;show_more=0';
            $s .= '<a href="'.$uri.'">'._("<img src=\"../images/forward.png\" border=\"0\" align=\"absmiddle\" alt=\"Next\">").'</a>';
        } else {
            $s .= _("<img src=\"../images/forward.png\" border=\"0\" align=\"absmiddle\" alt=\"Next\">");
        }
    ...
    $s .= makeComposeLink($comp_action_uri, _("<img src=\"../images/forward_msg.png\" border=\"0\" align=\"absmiddle\" alt=\"Forward\">"));

    if ($enable_forward_as_attachment) {
        $comp_action_uri = $comp_uri . '&amp;smaction=forward_as_attachment';
        $s .= $topbar_delimiter;
	$s .= makeComposeLink($comp_action_uri, _("<img src=\"../images/forward_atch.png\" border=\"0\" align=\"absmiddle\" alt=\"Forward as Attachment\">"));
    }

    $comp_action_uri = $comp_uri . '&amp;smaction=reply';
    $s .= $topbar_delimiter;
    $s .= makeComposeLink($comp_action_uri, _("<img src=\"../images/reply.png\" border=\"0\" align=\"absmiddle\" alt=\"Reply\">"));

    $comp_action_uri = $comp_uri . '&amp;smaction=reply_all';
    $s .= $topbar_delimiter;
    $s .= makeComposeLink($comp_action_uri, _("<img src=\"../images/reply_all.png\" border=\"0\" align=\"absmiddle\" alt=\"Reply All\">"));
    $s .= '</small></td></tr></table>';
...
function formatToolbar($mailbox, $passed_id, $passed_ent_id, $message, $color) {
    ...
    $s  = "<TR>\n" .
          ...
          '<a href="'.$url.'">'._("<img src=\"../images/mail_headers.png\" border=\"0\" align=\"absmiddle\" alt=\"View Full Header\">").'</a>';
...
echo '<TR><TD HEIGHT="5" COLSPAN="2" BGCOLOR="white"></TD></TR>'."\n";
...
//   echo '        <tr>' . html_tag( 'td', '', 'left', );              
   echo '           <b>' . _("Attachments") . ':</b>';
   echo '        </td></tr>';
   echo '        <tr><td>';
   echo '          <table width="100%" cellpadding="2" cellspacing="2" align="center"'.' border="0" class="attach_box_bottom"><tr><td>';
