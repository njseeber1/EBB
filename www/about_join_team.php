  ...
  <div class="container">
      <div class="main">
          ...
          <div class="nav">
            ...
            <div class="innerhead">About Us</div>
            <div class="bodytxt">
              <div class="bodytxtlt">
                  <ul>
                ...
                <div class="bodytxtrt">
                  <h1>Join Our Team</h1>
                <p>We are privileged to serve our customers. How would you like to join an exciting team to be successful and make the American dream come true to many?</p>
        <p><span class="bold1x">For information call Mathew Abraham 303-743-7303 or <a href="#" id="contactTeam">click here.</a></span> </p>
...
<div class="overlay hide" >
    <div id="alert"></div>
    <form id="enquiry2" name="enquiry" method="post" action="">
        <div class="box">
        <h3>Contact Form</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#contactFoot, #contactTeam").on("click touch", function(e){
            e.preventDefault();
