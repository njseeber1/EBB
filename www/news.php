<?php
$root = 'admin/';
include_once($root.'bll/news.php');
$news = new News();
$news->setCompanyId(1);
$dtNews = $news->GetNews();
?>
            ...
            <div class="bodytxt">
                ...
                <div class="bodytxtrt">
                    <div class="bodytxtbox">
                        <h1>News &amp; Laws</h1>
                        <p>News and information about the latest developments in real estate and related laws.</p>
                    

                    </div>
                     <?php
                        for($cnt = 0; $cnt < count($dtNews); $cnt++){
                            echo '
                            <div class="bodytxtbox">
                                <h3>'.$dtNews[$cnt]->heading.'</h3>
                                <h6>'.$dtNews[$cnt]->author.' &nbsp; on &nbsp; '.$dtNews[$cnt]->newsDate.'</h6>
                                <p>'.$dtNews[$cnt]->content.'</p>
                            </div>
                            ';
                        }
                      ?>
