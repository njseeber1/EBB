...
<body>
<div class="wrap" ng-app="App" ng-controller="ListingsCtrl as list" ng-init="list.init('current')">
  <div class="container">
      <div class="main">
          <div class="header">
              <div class="hdltcol">
        ...
        <div class="listingbox" ng-repeat="l in list.show" ng-if="list.meetsCriteria(l)">
          ...
          <div class="listingboxcol">
            <div class="bodylistingslt">
              ...
              <div class="listnav">
                <ul>
                <li><a inc="{{l.listingId}}" listing="l" map loc="{{l.location}}" city="{{l.city}}" class="location">View Location</a></li>
                <li><a inc="{{l.listingId}}" listing="l" ng-href="uploads/downloads/brochure_{{l.listingId}}.pdf" >Download Brochure</a></li>
                <li><a inc="{{l.listingId}}" listing="l" ng-click="list.setCurrent(l)">Send Query</a><span class="hide"> {{ l.title }} </span></li>
                </ul>
              </div>
            </div>
            <div class="bodylistingsrt">
              ...
              <div class="listingcol">
                <table width="260" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                  <td width="130" height="35" class="listinghl">Views:</td>
                  <td width="140" height="35"> {{ l.count }} </td>
                  </tr>
                </table>
              </div>
            </div>
