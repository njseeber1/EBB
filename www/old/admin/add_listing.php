<?php
	...
	?>
		...
		<tr>
			<td align="right" class="row_main"><b><? echo $lang[admin_listings_editor_mlsimport] ?> </b><br><div class="small">(<? echo $lang[admin_listings_editor_notes_mlsimport] ?>)</div></td>
			<td align="left" class="row_main">
			<select size="1" name="mlsimport">
