...
?>
	...
	<form action="member_form_submit.php" method="post">
...
<?
	...
	global $conn;
	$sql = "SELECT field_type, field_name, field_caption, default_text, field_elements, rank, required from " . $config[table_prefix] . "userFormElements ORDER BY rank, field_caption";
