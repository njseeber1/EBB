<?php
	...
	function getAllUsersData()
	{
		...
		$sql = "SELECT user_name, emailAddress, ID FROM " . $config[table_prefix] . "UserDB where isAdmin = 'No' and isAgent = 'Yes' order by creation_date";
...
function renderFeaturedListingsVertical2($num_of_listings)
	{
		...
		echo "</tr></table>";
	} // end function renderFeaturedListingsVertical2
