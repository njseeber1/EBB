...
/* ***************************************************** */
/*       Mortgage Simulator  MOD FOR OPEN REALTY         */
/*                   VERSION 200903                      */
/*              RealtyOne www.outbackweb.net             */
/* ***************************************************** */
	include("../../include/common.php");
	global $conn, $config, $price, $lang;
...
<?php
	...
	/*if (!headers_sent()) {
		...
		print("<h1>Mortgage Calculator</h1>\n");
		print("<b>Printer Version</b> [ <a href=\"calc.php\">full version</a> ]<br>\n");
		print("<hr>\n\n");
		$print_footer = TRUE;
	} else {
		$print_footer = FALSE;
...
<table border="<?php echo $style['admin_listing_border'] ?>" cellspacing="<?php echo $style['admin_listing_cellspacing'] ?>" cellpadding="<?php echo $style['admin_listing_cellpadding'] ?>" width="<?php echo $style['admin_table_width'] ?>" class="form_main">
		<tr>
				<td>
				<? renderFeaturedListingsHorizontal(4); ?>
				<h3><?	
	//include("$config[realedit_path]/headers/calculator.html"); 
	?>	</h3>
<hr><br>
<font size="-1" color="#666666">
	<?	
	//include("$config[realedit_path]/pages/calculator.html"); 
	?>	
<br></font>
	<?php	
	/* --------------------------------------------------- */
	...
	if ($form_complete) {
		...
		if (((float) $year_term <= 0) || ((float) $sale_price <= 0) || ((float) $annual_interest_percent <= 0)) {
			$error = "You must enter a <b>Sale Price of Home</b>, <b>Length of Mortgage</b> <i>and</i> <b>Annual Interest Rate</b>";
		}
...
?>
		<tr valign="top">
			<td align="center" colspan="2" bgcolor="#999999"><font color="#ffffff"><b>Mortgage Payment Information</b></font></td>
		</tr>
		<tr valign="top" bgcolor="#cccccc">
		...
		?>
				<tr valign="top" bgcolor="#cccccc">
					<td align="right">&nbsp;</td>
					<td>
						<br><font size="1" color="Red">Information For Some Countrys/States May Or MAy not Concern you:</font><br>
		...
		<tr valign="top" bgcolor="#cccccc">
			...
			<td>
				...
				?><font size="1" color="Red">Information For Some Countrys/States May Or MAy not Concern you:</font><br>
...
<?php
		...
		print("<table cellpadding=\"5\" cellspacing=\"0\" bgcolor=\"#cccccc\" border=\"1\" width=\"100%\">\n");
