...
if($user->userName == ''){
	...
	$dtUser = GetUserDetails();	
}
?>
<!DOCTYPE html>
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
<title>Edit User - CMS Datazone Systems LLC</title>
			...
			<div class="row">
				<div class="span12, offset0">
					...
					<form name="userForm" method="post" action="dashboard.php">
						...
						<input  name="uId" value ="<?php echo $dtUser[0]->uId;?>" type="hidden">
						<fieldset><legend>User Details</legend>
							<div class="clearfix"><label for="name">User Name</label>
								<div class="input"><input class="xlarge" id="xlInput" name="name" size="30" type="text" value ="<?php echo $dtUser[0]->userName;?>"></div>
							</div>
							<!-- /clearfix -->
							<div class="clearfix"><label for="email">Email Address</label>
								<div class="input"><input class="xlarge" id="xlInput" name="email" size="30" type="text" value ="<?php echo $dtUser[0]->email;?>"></div>
							</div>
							<!-- /clearfix -->
							...
							<!-- /clearfix -->
							<div class="actions"><input type="submit" class="btn primary" value="Update" onclick="return checkform();">&nbsp;<a href="dashboard.php" class="btn">Cancel</a></div>
