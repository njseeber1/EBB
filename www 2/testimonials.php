            ...
            <div class="bodytxt">
                ...
                <div class="bodytxtrt">
                    <div class="bodytxtbox">
                         <h1>Testimonials</h1>
                        <p>Our excellent reputation is built on our clients' experiences. We get lots of great feedback. These are some testimonials that have been sent in by our clients.  </p>
                    ...
                    <?php
                        for($cnt = 0; $cnt < count($dtTestimonials); $cnt ++){
                            echo '
                             <div class="bodytxtbox">
                                <h3>'.$dtTestimonials[$cnt]->title.'</h3>
                                <p>&quot;'.$dtTestimonials[$cnt]->testimonial.'&quot; </p>
                                <h6>- '.$dtTestimonials[$cnt]->author.'</h6>
                            </div> 
                            ';
                        }
                    ?>
